...
//           config
//         );
//         // console.log(response.data.mcqIds[0].ans);
...
//     exams.forEach((question) => {
//       const correctOption = question.ans; // assuming `correctOption` is provided in API response
...
//         correctCount++;
//         marks += question.marks; // assuming `marks` is provided in the question
//       }
//     });
...
//                   name={e._id}
//                   checked={selectedAnswers[e._id] === option}
//                   onChange={() => handleOptionChange(e._id, option)}
//                   className="w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-500"
//                 />
//                 <span className="text-gray-700">{option}</span>
//               </label>
...
//           <p className="text-gray-800 mt-2">Correct Answers: {correctAnswerCount}</p>
//           <p className="text-gray-800 mt-2">Total Marks: {totalMarks}</p>
//         </div>
//       )}
//     </div>
//   );
